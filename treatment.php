...
if(isset($_POST['submit']))
{
	...
	{
		$sql ="INSERT INTO treatment(treatmenttype,treatment_cost,note,status,db) values('{$_POST['treatmenttype']}','{$_POST['treatmentcost']}', '{$_POST['textarea']}','{$_POST['select']}','{$_SESSION['userdb']}')";
		if($qsql = mysqli_query($con,$sql))
		{
					...
					<div class="col-sm-12">
						<div class="form-group">
							...
							<div class="form-line">
								...
								rows="5"><?php if(isset($_GET['editid'])){echo $rsedit['note'] ;} ?></textarea>
