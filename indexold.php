          ...
          <div role="tabpanel">
            <div class="dep-sec-nav"> 
              ...
              <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active"><a href="#emergency" role="tab" data-toggle="tab"> Emergency </a></li>
                ...
                <li role="presentation"><a href="#gynacology" role="tab" data-toggle="tab">Gynacology </a></li>
                <li role="presentation"><a href="#laboratory" role="tab" data-toggle="tab">Laboratory </a></li>
              </ul>
            </div>
            ...
            <div class="tab-content"> 
              ...
              <!-- Dental Depatment -->
              <div role="tabpanel" class="tab-pane fade in active" id="emergency"> 
                ...
                <div class="dep-sec-txt">
                  <div class="row">
                    ...
                    <div class="col-md-offset-1 col-md-4">
                      <div class="doctor-img"> <img class="img-responsive" src="images/doctor-img.jpg" alt="" >
                        <div class="name-doc">
                          <h6>Doctor Name here<br><span> Specialists</span></h6>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <!-- For disabled -->
              <div role="tabpanel" class="tab-pane fade" id="gynacology"> 
                <!-- Depatment Text Section -->
                <div class="dep-sec-txt">
                  <div class="row">
                    <div class="col-md-7">
                      <h5>Our Best <span>Gyncology</span> Services </h5>
                      <p> It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, <br>
                        <br>
                        It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s PageMaker including versions of Lorem Ipsum. </p>
              ...
              <div role="tabpanel" class="tab-pane fade" id="dental"> 
                ...
                <div class="dep-sec-txt">
                  <div class="row">
                    <div class="col-md-7">
                      <h5>Our Best <span>Dental Department</span> Services</h5>
                      <p> It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, <br>
                        <br>
                        It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s PageMaker including versions of Lorem Ipsum. </p>
                    ...
                    <!-- Doctor Img -->
                    <div class="col-md-offset-1 col-md-4">
                      <div class="doctor-img"> <img class="img-responsive" src="images/doctor2-img.jpg" alt="" >
                        <div class="name-doc">
              ...
              <div role="tabpanel" class="tab-pane fade" id="laboratory"> 
                ...
                <div class="dep-sec-txt">
                  <div class="row">
                    <div class="col-md-7">
                      <h5>Our Best <span>Laboratory</span> Services</h5>
                      <p> It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, <br>
                        <br>
                        It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s PageMaker including versions of Lorem Ipsum. </p>
                    ...
                    <!-- Doctor Img -->
                    <div class="col-md-offset-1 col-md-4">
                      <div class="doctor-img"> <img class="img-responsive" src="images/doctor3-img.jpg" alt="" >
                        <div class="name-doc">
                          <h6>Dr. Narendra Mehta<br><span>Lab Specialists</span></h6>
                        </div>
                      </div>
                    </div>
                  </div>
