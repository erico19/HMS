 	...
 	<table class="table table-bordered table-striped">
      <tbody>
        <tr>
          ...
          <td>Slip Number &nbsp;</td>
          <td><?php echo $rsbilling_records['serviceid']; ?></td>
        </tr>
        <tr>
...
?>
  &nbsp;Rs. <?php echo $billamt; ?></td>
		...
		<tr>
		  ...
		  <td>Rs. <?php
		  	$sqlpayment ="SELECT sum(paidamount) FROM payment where patientid='{$_GET['patientid']}'";
...
<?php
$sqlpayment = "SELECT * FROM payment where patientid='{$_GET['patientid']}'";
$qsqlpayment = mysqli_query($con,$sqlpayment);
