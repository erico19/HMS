                                    ...
                                    <ul class="row">
                                        <li class="col-sm-6">
                                            <label>
                                                ...
                                                <input placeholder="Patient Name" type="text" class="form-control"
                                                    ...
                                                    value="<?php if(isset($_SESSION['patientid'])){echo $rspatient['patientname'];}  ?>"
                                                    <?php if(isset($_SESSION['patientid'])){echo $readonly;} ?>>
                                                <i class="icon-user"></i>
                                            </label>
                                        ...
                                        <li class="col-sm-6">
                                            <label><input placeholder="Address" type="text" class="form-control"
                                                    ...
                                                    value="<?php if(isset($_SESSION['patientid'])){echo $rspatient['address'];}  ?>"
                                                    <?php if(isset($_SESSION['patientid'])){echo $readonly;} ?>><i class="icon-compass"></i>
                                            </label>

                                        </li>
                                        <li class="col-sm-6">
                                            <label><input placeholder="City" type="text" class="form-control"
                                                    name="city" id="city" value="<?php if(isset($_SESSION['patientid'])){echo $rspatient['city'];}  ?>"
                                                    <?php if(isset($_SESSION['patientid'])){echo $readonly;} ?>><i class="icon-pin"></i>
                                            </label>
                                        ...
                                        <li class="col-sm-6">
                                            <label>
                                                <input placeholder="Mobile Number" type="text" class="form-control"
                                                    ...
                                                    value="<?php if(isset($_SESSION['patientid'])){echo $rspatient['mobileno'];}  ?>"
                                                    <?php if(isset($_SESSION['patientid'])){echo $readonly;} ?>><i class="icon-phone"></i>
                                            </label>
                                        ...
                                        <li class="col-sm-6">
                                            <label>
                                                <input placeholder="Login ID" type="text" class="form-control"
                                                    ...
                                                    value="<?php if(isset($_SESSION['patientid'])){echo $rspatient['loginid'];}  ?>"
                                                    <?php if(isset($_SESSION['patientid'])){echo $readonly;} ?>><i class="icon-login"></i>
                                            </label>
                                        ...
                                        <li class="col-sm-6">
                                            <label>
                                                ...
                                                <input placeholder="Password" type="password" class="form-control"
                                                    ...
                                                    value="<?php if(isset($_SESSION['patientid'])){echo $rspatient['password'];}  ?>"
                                                    <?php if(isset($_SESSION['patientid'])){echo $readonly;} ?>><i class="icon-lock"></i>
                                            </label>
                                        ...
                                        <li class="col-sm-6">
                                            <label>
                                                <input placeholder="Date of birth" type="text" class="form-control"
                                                    ...
                                                    value="<?php if(isset($_SESSION['patientid'])){echo $rspatient['dob'];} ?>" <?php if(isset($_SESSION['patientid'])){echo $readonly;} ?>><i
