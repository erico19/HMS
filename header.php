...
if(!isset($noconnection)){ require_once("include/dbconnection.php"); }
$dt = date("Y-m-d");
$tim = date("H:i:s");
?>
<!doctype html>
...
<meta name="author" content="Soluxionz" />
<!-- Document Title -->
  ...
  <div class="top-bar">
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="social-icons"> <a href="https://www.facebook.com/soluxionz"><i class="fa fa-facebook"></i></a> <a href="#"><i class="fa fa-twitter"></i></a> <a href="https://www.itsourcecode.com/"><i class="fa fa-dribbble"></i></a> <a href="#"><i class="fa fa-linkedin"></i></a> <a href="#"><i class="fa fa-youtube"></i></a> </div>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="head-info">
        <ul>
          ...
          <li> <i class="fa fa-envelope-o"></i>
            <p>help@sample.com<br>
              info@sample.com</p>
          </li>
          <li> <i class="fa fa-map-marker"></i>
            <p>Kamran Road, Attock <br>
             Pakistan</p>
          </li>
        </ul>
      </div>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="nav-open-btn">
          <ul class="nav">
            ...
            <li><a href="patientappointment">Appointment </a></li>
