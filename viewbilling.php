...
?>
 	<table class="table table-bordered table-striped">
      <tbody>
        ...
        <tr>
          <th width="124" scope="col"><div align="right">Slip ID &nbsp; </div></th>
          	<td width="413"> <?php echo $rsbilling_records['slipid']; ?>
            </td>
        </tr>
	...
	<table class="table table-bordered table-striped">
      <thead>
       <tr>
		...
		{
        echo "<tr>
          	<td>&nbsp;{$rs['bill_date']}{$rs['billingservice_id']}</td>
		 	<td>&nbsp; {$rs['bill_type']}";
...
if($rs['bill_type']  == "Prescription charge")
{
    ...
    <table class="table table-bordered table-striped">
      <tbody>
        <tr>
          <th width="442" scope="col"><div align="right">Bill Amount &nbsp; </div></th>
          <td width="95">&nbsp;Rs. <?php echo $billamt; ?></td>
        </tr>
		...
		<tr>
		  ...
		  <td>&nbsp;Rs. <?php echo $billamt   - $rsbilling_records['discount'] ; ?></td>
	    </tr>
      </tbody>
    </table>
