        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list" style="overflow: hidden; width: auto; height: calc(-184px + 100vh);">
                    ...
                    <li class="active open"><a href="dashboard"><i
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                        ...
                        <ul class="ml-menu">
                            <li><a href="hospitalprofile">Hospital Profile</a></li>
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                        ...
                        <ul class="ml-menu">
                            ...
                            <li><a href="viewappointmentpending">View Pending Appointments</a>
                            </li>
                            <li><a href="viewappointmentapproved">View Approved
                                    Appointments</a></li>
                        </ul>
                    </li>
                    ---->
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                        ...
                        <ul class="ml-menu">
                            <li><a href="doctor">Add Doctor</a>
                            </li>
                            <li><a href="viewdoctor">View Doctor</a></li>
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                        ...
                        <ul class="ml-menu">
                            ...
                            <li><a href="viewpatient">View Patient Records</a></li>
                        </ul>
                    </li>
					<li><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-flag"></i><span>Panel Organization</span> </a>
                        <ul class="ml-menu">
					...
					<li><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-receipt"></i><span>Slip Registration</span> </a>
                        <ul class="ml-menu">
                            <li><a href="addslip">Add Slip</a></li>
                            <li><a href="viewslip">View Slip</a></li>
                        </ul>
                    </li>
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-money"></i><span>Billing</span> </a>
                        <ul class="ml-menu">
                            <li><a href="viewbill">Billing</a></li>
					...
					<li> <a href="javascript:void(0);" class="menu-toggle"><i
                        ...
                        <ul class="ml-menu">
                            ...
                            <li><a href="treatment">Add Treatment type</a></li>
                            <li><a href="viewtreatment">View Treatment types</a></li>
                            <li><a href="medicine">Add Medicine</a></li>
                            <li><a href="viewmedicine">View Medicine</a></li>
                        </ul>
                    </li>
