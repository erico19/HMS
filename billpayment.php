...
{
  $sql ="INSERT INTO payment(billingid,paiddate,paidtime,paidamount,status) values('{$_GET['billingid']}','$current_date','$current_time','{$_POST['paidamount']}','Active')";
 ...
 $sql ="UPDATE billing SET discount={$_POST['discountamount']}+ discount, discountreason=CONCAT('{$_POST['discountreason']} , ', discountreason) WHERE billingid='{$_GET['billingid']}'";
 $qsql = mysqli_query($con,$sql);
 echo mysqli_error($con);

 echo "<script>window.location='viewpaymentreport?billingid={$_GET['billingid']}'</script>";
}
...
$billappointmentid = $_GET['billingid'];
?>
<div class="container-fluid">
  ...
  <div class="card" style="padding: 10px">
      ...
      require_once("viewpaymentreport.php");
      ?>   
