...
<div class="toggle">
	<!-- Toggle Link -->
	<a href="#" title="Title of Toggle" class="toggle-trigger">Family Profile</a>
	<!-- Toggle Content to display -->
	<div class="toggle-content">
		<p><?php include("familydetail.php"); ?></p>
	</div><!-- .toggle-content (end) -->
</div><!-- .toggle (end) -->
...
<div class="toggle">
	...
	<div class="toggle-content">
		...
		include("viewbillingprofile.php"); 
		?>
        </p>
	</div><!-- .toggle-content (end) -->
</div><!-- .toggle (end) -->
...
?>
    ...
    <div class="toggle">
        ...
        <div class="toggle-content">
           ...
           // include("viewpaymentreportprofile.php"); ?>
                      <?php
	...
	$rsbilling_records = mysqli_fetch_array($qsqlbilling_records);
				  ...
				  <a class="btn btn-raised" href="paymentdischarge.php?appointmentid=<?php echo $_GET['patientid']; ?>&patientid=<?php echo $_GET['patientid']; ?>">Make Payment</a>
